...
namespace BookShoppingCartMvcUI.Migrations
{
    ...
    [Migration("20250125101937_stock_qty_check_constraint")]
    partial class stock_qty_check_constraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookShoppingCartMvcUI.Models.Book", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("AuthorName"), new[] { "BookName", "Image", "Price" });

                    b.HasIndex("BookName")
                        .HasDatabaseName("IX_Book_BookName");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("BookName"), new[] { "AuthorName", "Image", "Price" });
